...
We are conducting an in-class competition on Kaggle. You can find instructions [here](https://www.kaggle.com/code/dmitryrekesh/benchmark-spring-2023). You may need to create a user on the platform first.
